...
class MYEW_Example_Widget extends Widget_Base{
    ...
    public function get_title(){
        return esc_html__( 'Example Widgets', 'my-elementor-widgets' );
    }
    ...
    public function _register_controls(){
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => __( 'Content Settings', 'my-elementor-widgets'),
    ...
    protected function render(){
        $mywe_values = $this->get_setting_for_display();
        ?>
        
        <div>
            <h1>This is an examle Widget</h2>
        </div>
